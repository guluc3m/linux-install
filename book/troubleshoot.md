...
Para esto necesitaras un disco o memoria USB externa desde la que podrás cargar un GNU/Linux en modo LiveOS (preferiblemente el mismo distributivo que el que tienes instalado). Para ello tendrás que [crear un LiveUSB](liveusb.md#cómo-crear-un-liveusb) y [arrancar desde él](liveusb.md#arrancar-desde-el-liveusb).
