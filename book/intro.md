...
- **Cosas que preparar:**
    ...
    - Un [Live USB con Linux](liveusb.md#cómo-crear-un-liveusb).

Guía de como instalarlo en [Full Install](guides/full-install.md).
...
Guía de cómo instalarlo en [`dualboot-install.md`](guides/dualboot-install.md).
...
Guía de cómo instalarlo en [`wsl-install.md`](guides/wsl-install.md).
...
> [!NOTE]
> También puedes [correr Windows en una VM](post-install/windows.md#usando-una-máquina-virtual).
>
...
Guía de cómo instalarlo en [`vm-install.md`](guides/vm-install.md).
...
Guía de cómo instalarlo en [`dualboot-external-install.md`](guides/dualboot-external-install.md).


### Método 6: "Sólo la puntita"
Si quieres seguir el taller pero no quieres liarte a instalar nada (_cobarde_), un [Live USB con Linux](liveusb.md#cómo-crear-un-liveusb) te permite correr Linux desde él mismo, sin necesidad de instalar ninguna cosa.
...
También échale un vistazo a nuestra sección [post-install](post-install/intro.md) y nuestra [guía de juegos en Linux](post-install/play-on-linux.md).
